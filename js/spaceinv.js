...
enemyImage.src = 'images/morraparalanches.png'; // Substitua pelo caminho da sua imagem de inimigo

const bulletImage = new Image();
bulletImage.src = 'images/tiro.png'; // Substitua pelo caminho da sua imagem de munição

const enemyBulletImage = new Image();
enemyBulletImage.src = 'images/cavalo.png'; // Substitua pelo caminho da sua imagem de munição dos inimigos

const explosionImage = new Image();
explosionImage.src = 'images/explosion.gif';

const victoryImage = new Image();
victoryImage.src = 'images/ziggymoreu.png'; // Adicione aqui o caminho da sua imagem de vitória
